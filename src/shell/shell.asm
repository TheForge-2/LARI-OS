...
; Entry point of the shell, executed after the jump over the kernel functions.
entry:
...
; These functions are included at the beginning from the 'src/functions' folder.
